  ...
  render() {
    ...
    return (
      <List
        ...
        title="模板管理"
        filters={
          <TemplateFilter templateStatusChoices={templateStatusChoices} />
        }
      >
        <Datagrid>
          ...
          <FunctionField
            source="status"
            label="模板状态"
            render={record => TEMPLATE_STATUS_OPTIONS[record.status]}
          />
          <FunctionField
            source="created_at"
            label="模板创建时间"
...
export const TemplateList = connect(state => {
  return {
